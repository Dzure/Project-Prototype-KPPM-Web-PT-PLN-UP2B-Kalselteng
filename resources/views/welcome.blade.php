...
<section id="hero" class="d-flex align-items-center" style="background: linear-gradient(135deg, #36d1dc, #5b86e5);">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                ...
                <h2>Di website PT PLN (Persero) UP2B Kalselteng</h2>
                <div class="d-flex justify-content-center justify-content-lg-start">
                    <a href="/profilup2b" class="btn-get-started scrollto">Lihat Profil UP2B KALSELTENG</a>
                </div>
            </div>
    ...
    <section id="portfolio" class="portfolio">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                ...
                <p>Kegiatan-kegiatan yang telah dilaksanakan di PT PLN (Persero) UP2B Kalselteng</p>
            </div>
...
<section id="services" class="services section-bg">
  <div class="container" data-aos="fade-up">
    <div class="section-title">
      <h2>Foto Kegiatan</h2>
      <p>Foto kegiatan-kegiatan yang dilakukan di PT PLN (Persero) UP2B Kalselteng</p>
    </div>
    <div class="container">
      <div class="wrapper">
  ...
  <div class="section-title">
    ...
    <div class="mapouter">
        <div class="gmap_canvas">
            <iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=PT%20PLN%20(Persero)%20UP2B%20Kalselteng&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
